{
  den.aspects = {
    ...
    # xfsprogs and btrfs-progs arrive on their own: the nixpkgs filesystem
    # modules put them in system.fsPackages, which is environment.systemPackages.
    # Only the extras belong here.
    fs-xfs.nixos = {pkgs, ...}: {
